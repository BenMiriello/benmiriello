...
const GrabameetingCard = () => {
  ...
  return (
    <div style={{height: '48rem'}} className='relative overflow-hidden'>
      ...
      <div style={{zIndex: 4, backgroundColor: 'rgb(24 26 37 / 87%)'}} className='absolute flex flex-col justify-between w-full h-full p-8 sm:p-12'>
        ...
        <Link to={`${match.url}grabameeting`} className='cursor-pointer border-2 border-white mb-4 px-10 sm:px-20 py-10 inline-flex justify-center items-center font-oswald text-2xl tracking-wide'>
